...
module.exports = function(indicatorMixin, accessor_ohlc, indicator_ema) {  // Injected dependencies
  return function() { // Closure function
    ...
    function indicator(data) {
      ...
      return data.map(function(d, i) {
        if(i < 1) return datum(p.accessor.d(d), 0, middle, overbought, oversold);
        ...
        if(i >= p.period) {
          ...
          return datum(p.accessor.d(d), 0, middle, overbought, oversold);
        }
      })
    }
...
function datum(date, rsi, middle, overbought, oversold) {
  return { date: date, rsi: rsi, middle: middle, overbought: overbought, oversold: oversold };
