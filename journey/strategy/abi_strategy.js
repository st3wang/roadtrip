...
const symbols = ["COMPUSD","UMAUSD","IOTXUSD","RENUSD","CRVUSD","QUICKUSD","PAXUSD","XTZUSD","GTCUSD","DASHUSD","TRBUSD","YFIUSD","OXTUSD","BALUSD","CHZUSD","AXSUSD","ANKRUSD","TRUUSD","QNTUSD","XLMUSD","FORTHUSD","MASKUSD","ETCUSD","DOGEUSD","ALGOUSD","ZRXUSD","BANDUSD","OGNUSD","SUSHIUSD","REPUSD","CLVUSD","GRTUSD","REQUSD","BATUSD","OMGUSD","COTIUSD","RLCUSD","BNTUSD","MATICUSD","UNIUSD","DAIUSD","LTCUSD","SNXUSD","ETHUSD","TRIBEUSD","NKNUSD","LRCUSD","BTCUSD","ICPUSD","STORJUSD","NMRUSD","DOTUSD","CTSIUSD","BCHUSD","SOLUSD","MKRUSD","MIRUSD","BONDUSD","FARMUSD","FETUSD","ENJUSD","ATOMUSD","SKLUSD","KNCUSD","1INCHUSD","EOSUSD","ADAUSD","MANAUSD","ZECUSD","LINKUSD","MLNUSD","AAVEUSD","KEEPUSD","ORNUSD","LPTUSD","NUUSD","YFIIUSD","FILUSD"]
// const coinbaseSymbols = ['COMPUSD', 'UMAUSD', 'AMPUSD', 'IOTXUSD', 'RENUSD', 'CRVUSD', 'PLAUSD', 'QUICKUSD', 'PAXUSD', 'XTZUSD', 'GTCUSD', 'CGLDUSD', 'DASHUSD', 'TRBUSD', 'YFIUSD', 'OXTUSD', 'BALUSD', 'CHZUSD', 'AXSUSD', 'ANKRUSD', 'TRUUSD', 'QNTUSD', 'XLMUSD', 'FORTHUSD', 'MASKUSD', 'ETCUSD', 'DOGEUSD', 'ALGOUSD', 'ZRXUSD', 'BANDUSD', 'OGNUSD', 'SUSHIUSD', 'REPUSD', 'CLVUSD', 'GRTUSD', 'REQUSD', 'BATUSD', 'OMGUSD', 'COTIUSD', 'RLCUSD', 'RLYUSD', 'BNTUSD', 'MATICUSD', 'UNIUSD', 'DAIUSD', 'LTCUSD', 'SNXUSD', 'ETHUSD', 'TRIBEUSD', 'NKNUSD', 'LRCUSD', 'BTCUSD', 'ICPUSD', 'USDTUSD', 'RAIUSD', 'STORJUSD', 'NMRUSD', 'DOTUSD', 'WLUNAUSD', 'CTSIUSD', 'BCHUSD', 'SOLUSD', 'MKRUSD', 'MIRUSD', 'BONDUSD', 'RADUSD', 'FARMUSD', 'FETUSD', 'POLYUSD', 'ENJUSD', 'ATOMUSD', 'SKLUSD', 'KNCUSD', '1INCHUSD', 'DDXUSD', 'EOSUSD', 'ADAUSD', 'MANAUSD', 'USTUSD', 'ZECUSD', 'LINKUSD', 'ACHUSD', 'MLNUSD', 'AAVEUSD', 'KEEPUSD', 'WBTCUSD', 'ORNUSD', 'LPTUSD', 'NUUSD', 'YFIIUSD', 'FILUSD']
