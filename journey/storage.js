...
async function writeTradesCSV(writePath,trades) { try {
  var outputString =
    'number,timestamp,cumQty,status,entry,exit,stop,cost%,fee%,pnl%,wl,cwl,group,grouppnl,num,balance,balance%,busd,dd%,ddusd%,psize,risk%,riskratio,hoursInTrade,avgInTrade,avgGroupInTrade'
